...
func (m *MockUsersRepository) Create(u entities.IUser) errors.IAppError {
	m.ctrl.T.Helper()
...
func (m *MockUsersRepository) FindByEmail(email string) (*entities.IUser, errors.IAppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByEmail", email)
	ret0, _ := ret[0].(*entities.IUser)
